...
export default function ArtifactCard({ artifact, readingStatus }: ArtifactCardProps) {
  ...
  return (
    <Link
      ...
      className="group block bg-surface-container-lowest rounded-sm shadow-[0_10px_30px_rgba(27,28,25,0.06)] overflow-hidden transition-transform duration-200 hover:scale-[1.02]"
    >
      {/* Cover */}
      <CoverImage
      ...
      <div className="p-3 space-y-2">
        <h3 className="font-headline text-sm text-on-surface font-semibold leading-snug line-clamp-2">
          {artifact.title}
        </h3>
